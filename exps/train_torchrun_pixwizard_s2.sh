...
train_data_root='configs/data/image2image_s2.yaml'
...
load_type=PixWizard     # PixWizard  /  Lumina

exp_name=s2_${model}_bs${batch_size}_lr${lr}_${precision}_${image_size}px_vae${vae}_seed${seed}
mkdir -p results/"$exp_name"

torchrun --nproc_per_node=8 --nnodes=1 --master_port=18181 python -W ignore -u train.py \
